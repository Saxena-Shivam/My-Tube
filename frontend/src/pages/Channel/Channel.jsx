  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="h-48 md:h-64 bg-gradient-to-r from-blue-500 to-purple-600 relative">
        {channel.coverImage && (
          <img src={channel.coverImage || "/placeholder.svg"} alt="Cover" className="w-full h-full object-cover" />
        )}
      </div>
      ...
      <div className="px-6 py-8">
        <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{channel.fullName}</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">@{channel.username}</p>
        ...
        <div className="mt-8">
          ...
          <div className="text-center py-8 text-gray-500 dark:text-gray-400">Channel videos coming soon...</div>
        </div>
      </div>
    </div>
  )
